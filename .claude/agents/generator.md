...
5. Only use existing skills in `.claude/skills/` or raw tools for manual operations.
...
| STANDARDS.md | Project conventions | `.claude/knowledge_base/STANDARDS.md` |
| Skills | Reusable procedures | `.claude/skills/` / `.claude/knowledge_base/incubator/` |
